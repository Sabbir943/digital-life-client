...
const MyLessons = () => {
    ...
    const fetchMyLessons = async () => {
        ...
        try {
            ...
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/lessons?email=${user.email}`);
    ...
    const handleDeleteLesson = async (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/lessons/${id}`, { method: 'DELETE' });
                    if (res.ok) {
    ...
    const handleUpdateSubmit = async (e) => {
        ...
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/lessons/${editingLesson._id}`, {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
