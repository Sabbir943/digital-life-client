...
const ReportedLessons = () => {
    ...
    const handleIgnore = async (id) => {
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/admin/reports/${id}/ignore`, { method: 'DELETE' });
            if (res.ok) {
    ...
    const handleDeleteReported = async () => {
        ...
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/admin/lessons/${deleteTarget._id}`, { method: 'DELETE' });
            if (res.ok) {
